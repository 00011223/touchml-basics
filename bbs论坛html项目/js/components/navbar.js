        ...
        <div style={{height: '48px', backgroundColor: '#f8f8f8'}}>
            <div className="container h-100 d-flex align-items-center justify-content-between">
                ...
                <div className="d-flex">
                    <img src="./img/logo.png" style={{height: '32px'}} className="me-3"/>
                ...
                {isSignIn ? (
                        <div className="d-flex align-items-center">
                            ...
                            <div className="dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    <li><a className="dropdown-item" href="#">个人中心</a></li>
                    ...
                    (
                        <div>
                            <button onClick={()=>{location.href='./signIn.html'}} className="btn btn-success me-2">登录</button>
                            <button onClick={()=>{location.href='./signUp.html'}} className="btn btn-primary">注册</button>
                        </div>
                    )
                }
            </div>
